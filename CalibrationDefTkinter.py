...
def calibrate(camera, get_lower, get_upper, colorSlope, current_canvas):
    lower = get_lower()
    upper = get_upper()
    ...
    try:
        ...
        cv2.circle(colorToDepthFrame, (center_x, center_y), radius=3, color=(255, 0, 0), thickness=1)
        ...
        cv2.imshow("RGB Image", colorToDepthFrame)
        cv2.imshow("Mask", res) 
